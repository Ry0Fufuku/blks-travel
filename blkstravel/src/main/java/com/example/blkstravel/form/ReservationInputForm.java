package com.example.blkstravel.form;
...
public class ReservationInputForm {
	...
	public LocalDate getCheckinDate() {
		String[] checkinDateAndCheckinDate = getFromCheckinDateToCheckoutDate().split(" から ");
		return LocalDate.parse(checkinDateAndCheckinDate[0]);
	}
	// チェックアウト日を取得する
